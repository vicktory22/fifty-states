...
- [ ] `/settings`: click through all 14 themes; map recolors without remounting
- [ ] Refresh keeps the last theme
- [ ] `/?theme=nord` applies Nord and persists
...
- [x] `/?theme=nord` applies Nord and persists it (hydrate test)  
